    ...
    <div className="space-y-6">
      <RawMaterialForm
        ...
        initial={{
          ...
          reorderLevel: rawMaterial.reorderLevel == null ? undefined : Number(rawMaterial.reorderLevel),
          maximumStockLevel: rawMaterial.maximumStockLevel == null ? undefined : Number(rawMaterial.maximumStockLevel),
          storageLocation: rawMaterial.storageLocation ?? "",
          binNumber: rawMaterial.binNumber ?? "",
