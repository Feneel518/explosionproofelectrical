...
import { adjustCastingMasterStockAction } from "@/lib/actions/dashboard/casting-masters/adjustCastingMasterStock";
...
export default function CastingMasterOpeningStockCard({
  ...
  const onAdjustStock = () => {
    startAdjust(async () => {
      const res = await adjustCastingMasterStockAction({
        castingMasterId,
