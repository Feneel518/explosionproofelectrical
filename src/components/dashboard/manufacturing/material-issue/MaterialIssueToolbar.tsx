...
export default function MaterialIssueToolbar({ qp }: { qp: MaterialIssueQP }) {
  const [state, setState] = useQueryStates(materialIssueParsers, {
    shallow: false,
  });
    ...
    <div className="grid grid-cols-2 gap-3 lg:grid-cols-5">
      <div className="col-span-2">
        ...
        <Input
          ...
          placeholder="Search issued to / dept / purpose..."
        />
      </div>
      ...
      <div>
        ...
        <Select
          ...
          <SelectContent>
            {MATERIAL_ISSUE_STATUSES.map((status) => (
      ...
      <Button asChild className="col-span-2 lg:col-span-1">
        <Link href="/dashboard/manufacturing/material-issues/new">
