...
import {
  suppliersParsers,
  SuppliersQP,
} from "@/lib/searchParams/dashboard/suppliers/suppliersSearchParams";
import SuppliersToolbar from "./SuppliersToolbar";
import SupplierActions from "./SupplierAction";
...
export default function SuppliersTable({
  ...
  const [, setState] = useQueryStates(suppliersParsers, {
    shallow: false,
  });
              ...
              items.map((c) => (
                <TableRow key={c.id}>
                  ...
                  <TableCell className="text-right">
                    <SupplierActions id={c.id} deletedAt={c.deletedAt} />
                  </TableCell>
                </TableRow>
              ))
            )}
