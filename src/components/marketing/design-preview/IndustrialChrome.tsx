...
export function IndustrialHeader() {
  ...
  const links = [["CATALOG", "/catalog"], ["ENGINEERING", "/#engineering"], ["BLOG", "/blog"], ["OUR STORY", "/#our-story"], ["LET’S TALK", "/#contact"]];
...
export function IndustrialFooter() {
  return <footer className={styles.footer}><div className={styles.footerMain}>
    ...
    <nav aria-label="Footer navigation"><Link href="/catalog">Catalog <ArrowUpRight size={14} /></Link><Link href="/blog">Blog <ArrowUpRight size={14} /></Link><Link href="/#our-story">Our story <ArrowUpRight size={14} /></Link><Link href="/#contact">Contact <ArrowUpRight size={14} /></Link></nav>
