...
export const knowledgeArticles: KnowledgeArticle[] = [
  {
    ...
    shortTitle: "Ex d explained",
    category: "Protection concepts",
    description: "A practical explanation of Ex d flameproof enclosures, what the marking means and what Ex d does—and does not—guarantee.",
  ...
  },
  {
    ...
    shortTitle: "Gas hazardous-area zones",
    category: "Hazardous areas",
    description: "Understand how Zone 0, Zone 1 and Zone 2 describe the likelihood and duration of an explosive gas atmosphere.",
  ...
  },
  {
    ...
    shortTitle: "IIA, IIB and IIC",
    category: "Hazardous areas",
    description: "A clear guide to Group II gas subgroups IIA, IIB and IIC and how to read them on Ex equipment markings.",
  ...
  },
  {
    ...
    category: "Hazardous areas",
    description: "Learn what T1, T2, T3, T4, T5 and T6 mean on explosion-protected electrical equipment.",
  ...
  },
  {
    ...
    shortTitle: "Cable gland selection",
    category: "Equipment selection",
    description: "A step-by-step checklist for matching a flameproof cable gland to the cable, enclosure, hazardous area and certificate.",
  ...
  },
  {
    ...
    shortTitle: "India certification overview",
    category: "Compliance",
    description: "An introductory map of standards, testing, BIS licensing and PESO approval considerations for Ex electrical apparatus in India.",
    ...
    sources: [
      { label: "PESO — current SOP for Ex electrical apparatus", url: "https://www.peso.gov.in/en/sop-approval-ex-electrical-apparatus-installed-hazardous-areas" },
